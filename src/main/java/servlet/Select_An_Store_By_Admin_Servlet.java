...
@WebServlet(name = "select_an_store_by_admin",value = "/select_an_store_by_admin")
public class Select_An_Store_By_Admin_Servlet extends HttpServlet{
	private static final long serialVersionUID = 5232037978777490899L;
