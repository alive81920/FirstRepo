...
@WebServlet(name = "select_all_customer_by_admin",value = "/select_all_customer_by_admin")
public class Select_All_Customer_By_Admin_Servlet extends HttpServlet{
	private static final long serialVersionUID = 9026088924373479459L;
