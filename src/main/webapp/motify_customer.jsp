...
<jsp:include page="userheader.jsp" />
	...
	<div class="usercenter">
		<form action="motify_customer" method="post">
	<section>
		<div class="login">
			<h2>修改个人信息</h2>
			<div class="inputbox">
			...
			<div class="inputbox">
				<span>地址：</span>
				<input type="text" name="UserAdress" value="${user.getUserAdress() }" placeholder="请收货地址" required="required" oninput="if(value.length>45)value=value.slice(0,45)" onkeyup="value = value.replace(/([^0-9A-z\u4e00-\u9fa5]|[\^\_])/g,'')">
			</div>
			<div class="group">
