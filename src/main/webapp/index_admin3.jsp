...
<c:if test="${tpye_admin==1}"><jsp:include page="admin1header.jsp" /></c:if>
	...
	<ul><li class="box11seacher">
			<form action="select_an_customer_by_admin" method="post">
	...
	<table class="tabletolist">
		...
		<c:forEach items="${p.list }" var="g">
			<tr>
				...
				<td>
					<a class="btn btn-danger" href="#" onclick="delete_customer_by_ad(${g.getID()})">注销</a>
				</td>
			</tr>
		</c:forEach>
		</table>
		...
		<jsp:include page="Page.jsp">
			<jsp:param value="select_all_customer_by_admin" name="url"/>
		</jsp:include>
